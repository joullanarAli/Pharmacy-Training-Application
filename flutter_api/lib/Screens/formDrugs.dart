...
class formDrugsPage extends StatefulWidget {
  int id;
  String name;
  String image;
  String bearerToken;
  formDrugsPage({ required this.id,required this.name,required this.image,required this.bearerToken,super.key});
  @override
  _formDrugsState createState() => _formDrugsState();
}

class _formDrugsState extends State<formDrugsPage> {
  List<Drug> drugs = [];
  ...
  void getData() async {
    ...
    var urlDrugForms = Uri.parse('$urll/Drugs/GetDrugsByForm?formId=${widget.id}');
    ...
    drugs = jsonListDrugForms.map((json) => toDrug(json)).toList();
  ...
  Widget build(BuildContext context) {
    ...
    FormModel form= FormModel(widget.id, widget.name, widget.image);
                          ...
                          child: TextField(
                            ...
                            children:[
                              ...
                              Container(
                                  ...
                                  child:Text("There are no drugs that has this form yet",
                                    style: TextStyle(
                                      color: Colors.teal[700],
                                      fontSize: 20,
                                    ),
